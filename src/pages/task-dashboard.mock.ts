		...
		files: [
			{
				...
				progress: 100,
				resultLabel: '成片已生成',
				resultUrl: 'https://example.com/customer-story-ja.mp4',
				sourceVideoUrl: 'https://example.com/customer-story-origin.mp4',
				srcSrtUrl: 'https://example.com/customer-story-source.srt',
				tgtSrtUrl: 'https://example.com/customer-story-ja.srt',
				ocrTranslateTaskId: 'demo-ocr-task-1',
			},
		],
	},
	{
